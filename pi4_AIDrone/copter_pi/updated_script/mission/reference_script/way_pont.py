...
# =========================
USE_SITL = True   # Set to False for real drone, True for SITL
TARGET_ALTITUDE = 30.0  # meters (safe altitude for training)
...
if USE_SITL:
    ...
    CONNECTION_STRING = "/dev/serial/by-id/USB_SERIAL_HERE"  # Update with your Pixhawk serial port
    BAUD_RATE = 115200
